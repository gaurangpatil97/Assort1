    ...
    <Shell>
      <section className="p-6 lg:p-8 space-y-6 lg:space-y-8 max-w-[1200px] mx-auto w-full">
        <div className="flex justify-between items-end">
          <div>
            <h2 className="text-3xl font-bold text-[#131b2e] font-display leading-tight">Platform Overview</h2>
            <p className="text-[#434655] mt-1">Real-time stats across all participating organizations.</p>
          </div>
          <button 
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Total Companies */}
              <div className="bg-white border border-[#c3c6d7] rounded-xl p-5 shadow-sm flex flex-col justify-between h-36">
                <div className="flex justify-between items-start">
                  <div className="w-10 h-10 rounded-lg bg-[#2563EB]/10 flex items-center justify-center text-[#2563EB]">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
                      <path d="M160-120v-480l320-240 320 240v480H160Zm80-80h160v-240h160v240h160v-384L480-771 240-584v384Z"/>
                    </svg>
                  </div>
                  <span className="text-[#2563EB] text-xs font-semibold">+12% vs last mo</span>
                </div>
                <div>
                  <p className="text-xs text-[#434655] uppercase tracking-wider font-semibold">Total Companies</p>
              ...
              <div className="bg-white border border-[#c3c6d7] rounded-xl p-5 shadow-sm flex flex-col justify-between h-36">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[#434655] text-xs font-semibold">Live accounts</span>
                </div>
                <div>
                  <p className="text-xs text-[#434655] uppercase tracking-wider font-semibold">Active</p>
                  <h3 className="text-3xl text-[#131b2e] font-bold mt-1">{stats.active.toLocaleString()}</h3>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#c3c6d7] rounded-xl p-5 shadow-sm flex flex-col justify-between h-36">
                <div className="flex justify-between items-start">
                  <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
                      <path d="M480-240q100 0 170-70t70-170q0-100-70-170t-170-70q-100 0-170 70t-70 170q0 100 70 170t170 70Zm0 80q-133 0-226.5-93.5T160-480q0-133 93.5-226.5T480-800q133 0 226.5 93.5T800-480q0 133-93.5 226.5T480-160Zm0-320Z"/>
                    </svg>
                  </div>
                  <span className="text-[#434655] text-xs font-semibold">Setup required</span>
                </div>
                <div>
                  <p className="text-xs text-[#434655] uppercase tracking-wider font-semibold">Pending</p>
                  <h3 className="text-3xl text-[#131b2e] font-bold mt-1">{stats.pending.toLocaleString()}</h3>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#c3c6d7] rounded-xl p-5 shadow-sm flex flex-col justify-between h-36">
                <div className="flex justify-between items-start">
                  <div className="w-10 h-10 rounded-lg bg-red-100 flex items-center justify-center text-red-600">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
                      <path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm-40-320v-240h80v240h-80Zm0 160v-80h80v80h-80Z"/>
                    </svg>
                  </div>
                  <span className="text-red-600 text-xs font-semibold">Policy violations</span>
                </div>
                <div>
                  <p className="text-xs text-[#434655] uppercase tracking-wider font-semibold">Suspended</p>
                  <h3 className="text-3xl text-[#131b2e] font-bold mt-1">{stats.suspended.toLocaleString()}</h3>
                </div>
              </div>
            </div>
