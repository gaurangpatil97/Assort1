  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-[480px] sm:min-w-[420px] space-y-8 bg-surface-container-lowest p-6 sm:p-8 rounded-xl shadow-lg border border-outline-variant">
        <div>
          <h2 className="mt-2 text-center text-h2 font-display text-on-surface">Set new password</h2>
        </div>
        <form className="mt-8 space-y-6 w-full" onSubmit={handleSubmit}>
          <div className="space-y-4 w-full">
            <div className="w-full">
              <label htmlFor="password" className="block text-label-sm text-on-surface-variant uppercase tracking-wider mb-xs">New Password</label>
            ...
            <div className="w-full">
              <label htmlFor="confirm-password" className="block text-label-sm text-on-surface-variant uppercase tracking-wider mb-xs">Confirm New Password</label>
              <div className="relative">
                <input
                  id="confirm-password"
